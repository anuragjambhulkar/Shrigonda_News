...
function HomeContent() {
  ...
  const loadArticles = async () => {
    try {
      ...
      console.error('Failed to load articles (network error):', error);
    }
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <footer className="bg-black text-white mt-20">
        <div className="container py-12">
          ...
          <p className="text-center text-sm text-gray-400">© 2025 I Love Shrigonda News. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
